...
\chapter{Implementation} \label{solution:implementation}
	...
	\section{Sensor} \label{solution:implementation:sensor}
		\begin{figure}
			\centering
		...
		\subsection{Configuration file} \label{solution:implementation:sensor:config}
...
/etc/sensor/conf.d/*.conf
		...
		\subsection{Packet capturing} \label{solution:implementation:sensor:cap}
		...
		\subsection{Packet parsing} \label{solution:implementation:sensor:parse}
		...
		\subsection{Committing packets to ELK stack} \label{solution:implementation:sensor:commit}
		...
		\subsection{Checking disk usage} \label{solution:implementation:sensor:disk}		
...
/etc/sensor/requests.d/*.conf
		...
		\subsection{Logging} \label{solution:implementation:sensor:logging}
	...
	\section{ELK stack setup} \label{solution:implementation:elk}
