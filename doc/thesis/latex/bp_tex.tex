...
\begin{appendices}
	...
	\chapter{Installation guide} \label{appendix:install}
		\lstinputlisting[language=Clean, basicstyle=\tiny\ttfamily, breaklines=true]{guide/installation_guide}
	\chapter{User's guide} \label{appendix:userguide}
		\lstinputlisting[language=Clean, basicstyle=\tiny\ttfamily, breaklines=true]{guide/user_guide}
